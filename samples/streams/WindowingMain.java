...
public class WindowingMain {
    ...
    public static void main(String[] args) {
        ...
        // Apply windowing to the stream with tumbling time windows of 10 seconds. Hopping would be 
        // an advanced by duration > than the window size
        TimeWindowedKStream<String, String> windowedStream = 
            groupedStream.windowedBy(TimeWindows.of(Duration.ofSeconds(10)).advanceBy(Duration.ofSeconds(10)));
        // Combine the values of all records with the same key into a string separated by spaces, using 10-se
        KTable<Windowed<String>, String> reducedTable = 
            windowedStream.reduce((aggValue, newValue) -> aggValue + " " + newValue);
